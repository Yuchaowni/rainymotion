...
# note on 2020.3.11
# this code has not been used, because on 2020.2.25, I was given accesss to kakuho dev server and found 
# the source data with ints.1km.bin extension has the same data content with 400220382
